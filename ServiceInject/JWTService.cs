...
namespace TicketAppApi.ServiceInject
{
    public static class JWTService
    {
        ...
        public static MemoryCache Cache { get; set; } = new MemoryCache(
        ...
        public static IServiceCollection AddJwtService(this IServiceCollection services)
        {
            ...
            Cache.Set<string>("CacheName","JWTCache v1.0,InjectTime: "+DateTime.Now.ToString());
        ...
        public static IServiceCollection AddJWTAuthorizationService(this IServiceCollection services)
        {
            services.AddAuthorization(options =>
            {
                ...
                {
                    polic.RequireClaim(ClaimTypes.Email).RequireClaim(ClaimTypes.Sid).RequireClaim(ClaimTypes.Name).RequireClaim(ClaimTypes.Role);
                    ///添加鉴权方式
                });
            });
