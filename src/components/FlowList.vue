    ...
    <el-row>
        ...
        <el-col :span="10">
            <el-select style="width: 100%;" @change="comchange" v-model="companyselected" multiple filterable remote
                ...
                :loading="comloading" :multiple-limit=10>
        ...
        <el-col :span="8" style="padding-left: 2%;">
            <el-input @keyup.enter="search()" clearable v-model="keywords" placeholder="请输入单据编号"
...
import {
    getcompanys, getyewulist, getflowlist, GetAFlowAllInfo, OutputFlow,
