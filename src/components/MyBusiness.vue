...
import { deleteyewu, updateyewu,jiansuo_yewu_project,addnewproject,getAuserOwnAllBusinessDepartment ,GetOneBusinessDepartmentAllInfo} from '../request/api.js'
...
export default {
    ...
    methods: {
        ...
        search() {
            getAuserOwnAllBusinessDepartment(this.keywords != "" ? this.keywords : "#", this.currentPage,  this.pageSize).then(res => {
                if (res.status == true) {
