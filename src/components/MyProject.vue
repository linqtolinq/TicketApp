    ...
    <div style="margin-left: 0%;width: 100%;">
        ...
        <el-drawer v-model="addliushui_vi" title="添加项目流水" size="50%">
            ...
            <el-form ref="addnewLiushuiRef" :model="newliushui" status-icon :rules="rules" label-width="120px"
                ...
                <el-form-item>
                    <el-upload class="upload-demo" drag style="width: 100%;"
                         :on-change="flowuploadsu"
                        :auto-upload="false" v-model:file-list="filess" multiple>
        ...
        <el-drawer v-model="detailpro_v" title="项目详情" size="70%">
            ...
            <el-table :data="detailliushuimodel" border v-if="detailliushuimodel.length > 0">
                 <el-table-column fixed label="单据编号" prop="documentNumber" width="200" />
                <el-table-column  label="流水编号" prop="serialNumber" width="200" />
...
import { getcompanys, getAuserOwnAllBusinessDepartment, GetAprojectFlow, deletepro, addflowapi, GetFlowTypesSuggestion, GetProjectList, updatepoject, GetOneProjectAllInfo } from '../request/api.js'
    ...
    data() {
        return {
            ...
            rules: {
                ...
                Amount: [{ required: true, message: "该字段必填", validator: this.isintorfloat, trigger: ['blur', 'change'] }],
